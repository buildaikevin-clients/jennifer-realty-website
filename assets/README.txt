...
guides/moving-to-bradenton.pdf was on this list until 2026-08-16. The
relocation guide is a web page now, guides/relocating-to-lakewood-ranch.html,
generated by scripts/build-guides.js, and no page links a PDF anymore. If a
print version is ever wanted, generate it from the page so there is one
source of truth.
