...
const PHOTOS = {
  'anna-maria-island': {
    ...
    author: 'Ann Caron', license: 'Creative Commons Attribution ShareAlike 3.0',
  ...
  'holmes-beach': {
    ...
    author: 'Bobpinz', license: 'Creative Commons Attribution ShareAlike 4.0',
  ...
  'bradenton-beach': {
    ...
    author: 'Gregory Urbano', license: 'Creative Commons Attribution 2.0',
  ...
  'longboat-key': {
    ...
    author: 'Guspederson', license: 'Creative Commons Attribution ShareAlike 4.0',
    licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0',
  ...
  'cortez': {
    ...
    author: 'Ebyabe', license: 'Creative Commons Attribution ShareAlike 3.0',
    licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0',
  ...
  'perico-island': {
    ...
    author: 'Mark Hewitt', license: 'Creative Commons Attribution ShareAlike 3.0',
    licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0',
  ...
  'palma-sola': {
    ...
    author: 'Jrussell55265', license: 'Creative Commons Attribution ShareAlike 4.0',
    licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0',
  ...
  'west-bradenton': {
    ...
    author: 'Joseph Gage', license: 'Creative Commons Attribution ShareAlike 2.0',
  ...
  'bayshore-gardens': {
    ...
    author: 'Ryan Hodnett', license: 'Creative Commons Attribution ShareAlike 4.0',
    licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0',
  ...
  'lakewood-ranch': {
    ...
    author: 'Angiesbc', license: 'Creative Commons Attribution ShareAlike 4.0',
    licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0',
  ...
  'greyhawk-landing': {
    ...
    author: 'Paul R. Burley', license: 'Creative Commons Attribution ShareAlike 4.0',
    licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0',
  ...
  'river-strand': {
    ...
    author: 'Chad Sparkes', license: 'Creative Commons Attribution 2.0',
    licenseUrl: 'https://creativecommons.org/licenses/by/2.0',
  ...
  'parrish': {
    ...
    author: 'Mykhaylovdimitriy', license: 'Creative Commons Attribution ShareAlike 4.0',
    licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0',
  ...
  'downtown-bradenton': {
    ...
    author: 'Sanibel sun', license: 'Creative Commons Attribution ShareAlike 4.0',
    licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0',
...
const DATA = [
  ...
  },
  {
    ...
    faq: [
      ...
      ['How is the commute to Sarasota from here?',
       'Bayshore Gardens sits close to the county line, which makes it one of the shorter drives in Manatee County to downtown Sarasota and to Sarasota Bradenton International Airport. US 41 and Interstate 75 are both accessible, with 41 slower and more direct.'],
    ],
  ...
  /* --------------------------------------------------------------- east -- */
  {
    ...
    intro: [
      'Lakewood Ranch is a master planned development east of Interstate 75 that spans the Manatee and Sarasota county line, and it has been among the top selling planned communities in the country for years running. It is not a neighborhood so much as a collection of dozens of them, each with its own builder, price point, and association.',
  ...
  },
  {
    ...
    intro: [
      'Heritage Harbour is a large master planned area just east of Interstate 75 at State Road 64, and River Strand is the gated golf community within it. Together they hold one of the widest ranges of price points in east Manatee County, from condominiums to single family homes.',
    ...
    known: [
      ...
      'Immediate Interstate 75 access at State Road 64',
  ...
  },
  {
    ...
    intro: [
      'Ellenton sits on the north bank of the Manatee River at Interstate 75, and it is best known regionally for the outlet mall and the Gamble Plantation historic site. Residentially it is a mix of older housing, a number of manufactured home communities, and newer subdivisions filling in around them.',
      'The interstate position makes it one of the more convenient points in the county for driving anywhere else in the region.',
    ],
    known: [
      'Immediate Interstate 75 access, with Tampa and Sarasota both reachable quickly',
    ...
    faq: [
      ...
      ['Is Ellenton a good commuter location?',
       'It is among the better ones in the county for that purpose. Sitting at Interstate 75 on the north side of the river puts Tampa, St Petersburg, and Sarasota all within a reasonable drive. That is the main reason people choose it over areas closer to the beach.'],
...
/* The chrome (head, nav, footer, escapers) is shared with build-guides.js and
   lives in lib/chrome.js. It was extracted from this file on 2026-08-16 and
...
function hubPage() {
  const title = 'Bradenton Area Neighborhoods | Manatee County Guide | Jennifer Barragan';
  const description =
